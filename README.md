...
## POUR LES PROJETS PORTFOLIO
    ...
    * CREER UN PERSONA CLIENT
        * PARTICULIER
        ARTISAN/INDEPEDANT
        PETITE ENTREPRISE
        ASSOCIATION

    * CREER UN PERSONA VISITEUR
        PARTICULIER
        ARTISAN/INDEPEDANT
        * PETITE ENTREPRISE
        * ASSOCIATION
    ...
    SCENARIO:
    * CLIENT PARTICULIER
    * VISITEUR: PETITE ENTREPRISE / ASSOCIATION

    LE CLIENT A BESOIN D'UN SITE PORTFOLIO POUR PRESENTER SON CV
    AFIN DE SE FAIRE EMBAUCHER PAR UNE PETITE ENTREPRISE OU UNE ASSOCIATION

    => ASTUCE: S'INSPIRER DE SON ENTOURAGE


    LE CLIENT VEUT CREER UNE ASSOCIATION ET A BESOIN DE L'AIDE DE PETITES ENTREPRISES POUR DONNER DU MATERIEL
